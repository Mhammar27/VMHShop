export default function AboutUs() {
  return (
    <main className="max-w-3xl mx-auto py-16 px-4">
      <h1 className="text-4xl font-bold mb-4 text-gray-900">About VMH Construction</h1>
      <p className="text-lg text-gray-700 mb-6">
        <span className="font-semibold">VMH Construction Ltd</span> is a professional construction company based in Bristol, UK. With a commitment to quality craftsmanship, reliability, and customer satisfaction, we deliver outstanding residential and commercial projects across the region.
      </p>
      <div className="mb-8">
