    ...
    <main className="max-w-3xl mx-auto py-16 px-4">
      ...
      <div className="mb-10">
        <ul className="text-gray-700">
          <li><strong>Email:</strong> <a href="mailto:vhmconstructionltd@gmail.com" className="text-blue-600 underline">vhmconstructionltd@gmail.com</a></li>
          <li><strong>Phone:</strong> <a href="tel:+447342106747" className="text-blue-600 underline">+44 7342 106747</a></li>
      ...
      <form onSubmit={handleSubmit} className="bg-white p-6 rounded shadow-md max-w-xl">
        ...
        {submitted && (
          <div className="mb-4 text-green-600">Thank you for your message! We'll reply soon.</div>
        )}
        <button
